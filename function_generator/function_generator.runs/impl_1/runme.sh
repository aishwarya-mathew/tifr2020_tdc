...
HD_PWD='B:/TIFR/Fun Gen Files/Vivado/function_generator/function_generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Function_Generator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Function_Generator.tcl -notrace
