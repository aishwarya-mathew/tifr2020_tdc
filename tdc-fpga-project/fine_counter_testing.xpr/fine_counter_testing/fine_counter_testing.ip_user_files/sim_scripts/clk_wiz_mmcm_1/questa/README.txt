...
#
# Generated by export_simulation on Thu Aug 05 05:39:39 +0530 2021
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_mmcm_1.sh' script.

./clk_wiz_mmcm_1.sh -reset_run
...
./clk_wiz_mmcm_1.sh -noclean_files

For more information on the script, please type './clk_wiz_mmcm_1.sh -help'.
