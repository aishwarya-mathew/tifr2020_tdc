...
#
# Generated by export_simulation on Thu Aug 05 05:29:45 +0530 2021
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_mmcm_0.sh' script.

./clk_wiz_mmcm_0.sh -reset_run
...
./clk_wiz_mmcm_0.sh -noclean_files

For more information on the script, please type './clk_wiz_mmcm_0.sh -help'.
